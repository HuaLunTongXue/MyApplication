...
public class TestMD5Two {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File file = new File("/Users/kevin_zhuang/testMd5/123.txt");
...
//        System.out.print("is="+is);
        ...
        //文件名不同，内容相同；
        File file2 = new File("/Users/kevin_zhuang/testMd5/123(2).txt");
//        file2.createNewFile();
        String md52= getFileMD5String(file2);


        //文件名不同，内容不同；
        File file3 = new File("/Users/kevin_zhuang/testMd5/123(3).txt");
//        file3.createNewFile();
        String md53= getFileMD5String(file3);


        //测试压缩包
        File fileZip = new File("/Users/kevin_zhuang/testMd5/qwer.zip");
        String md5Zip= getFileMD5String(fileZip);

        //测试压缩包
        File fileZip2 = new File("/Users/kevin_zhuang/testMd5/qwer2.zip");
